 ...
 * underlying array using {@link #setArrayMapView(Object[], int, Object[], int, int)}.
 * Use {@link #getArrayMapView()} to retrieve the array view.
...
public class ArrayMapViewHandle<K, V> {
	 ...
	 * @param allowSet true to allow this handle's {@link ArrayMapView#set(int, Object)} method
